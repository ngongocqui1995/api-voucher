...
let MenusService = class MenusService extends crud_typeorm_1.TypeOrmCrudService {
    ...
    async updateOneBase(id, req, dto, lang) {
        const urlExist = await this.findOne({
            where: { url: dto.url, type: dto.type, id: (0, typeorm_2.Not)(id) },
        });
        this.checkService.checkUrlExist(!!urlExist);
        const [err, res] = await (0, await_to_js_1.default)(this.updateOne(req, dto));
        if (err)
...
], MenusService.prototype, "updateOneBase", null);
__decorate([
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, crud_1.ParsedRequest)()),
    __param(2, (0, crud_1.ParsedBody)()),
    ...
    __metadata("design:paramtypes", [String, Object, create_menu_dto_1.CreateMenuDto, String]),
    __metadata("design:returntype", Promise)
], MenusService.prototype, "replaceOneBase", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MenusService.prototype, "createOneBase", null);
__decorate([
    __param(2, (0, nestjs_i18n_1.I18nLang)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_status_dto_1.UpdateStatusDTO, String]),
    __metadata("design:returntype", Promise)
], MenusService.prototype, "updateStatus", null);
